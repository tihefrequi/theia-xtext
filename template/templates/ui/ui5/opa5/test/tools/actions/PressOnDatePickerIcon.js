...
sap.ui.define(['jquery.sap.global', '{app.idpath}/ui/test/tools/actions/GenericPress'], function ($, GenericPress) {
	 ...
	 * @public
	 * @name sap.ui.test.actions.PressDatePickerIcon
	 * @author frequi
	 */
	var PressOnDatePickerIcon = GenericPress.extend("{app.id}.test.tools.actions.PressOnDatePickerIcon", {
		...
		executeOn : function (oControl) {
			this.genericExecuteOn(oControl, "span");	
		}
	});
	return PressOnDatePickerIcon;
