sap.ui.define(['jquery.sap.global', '{app.idpath}/ui/test/tools/actions/GenericPress'], function ($, GenericPress) {
	 ...
	 * @public
	 * @name sap.ui.test.actions.PressOnDatePickerPreviousMonth
	 */
	var PressOnDatePickerPreviousMonth = GenericPress.extend("{app.id}.test.tools.actions.PressOnDatePickerPreviousMonth", {
		...
		executeOn : function (oControl) {
			this.genericExecuteOn(oControl, "button[aria-label=Previous]");
		}
	});
	return PressOnDatePickerPreviousMonth;
