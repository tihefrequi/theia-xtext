sap.ui.define(['jquery.sap.global', '{app.idpath}/ui/test/tools/actions/GenericPress'], function ($, GenericPress) {
	 ...
	 * @public
	 * @name sap.ui.test.actions.PressOnDatePickerNextMonth
	 */
	var PressOnDatePickerNextMonth = GenericPress.extend("{app.id}.test.tools.actions.PressOnDatePickerNextMonth", {
		...
		executeOn : function (oControl) {
			this.genericExecuteOn(oControl, "button[aria-label=Next]");
		}
	});
	return PressOnDatePickerNextMonth;
