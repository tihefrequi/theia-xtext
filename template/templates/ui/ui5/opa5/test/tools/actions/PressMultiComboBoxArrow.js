sap.ui.define(['jquery.sap.global', '{app.idpath}/ui/test/tools/actions/GenericPress'], function ($, GenericPress) {
	 ...
	 * @public
	 * @name sap.ui.test.actions.PressMultiComboBoxItem
	 */
	var PressMultiComboBoxItem = GenericPress.extend("{app.id}.test.tools.actions.PressMultiComboBoxItem", {
		...
		executeOn : function (oControl) {
			this.genericExecuteOn(oControl, "span[role=button]");
		}
	});
	return PressMultiComboBoxItem;
