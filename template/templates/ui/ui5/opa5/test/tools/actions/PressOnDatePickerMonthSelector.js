sap.ui.define(['jquery.sap.global', '{app.idpath}/ui/test/tools/actions/GenericPress'], function ($, GenericPress) {
	 ...
	 * @public
	 * @name sap.ui.test.actions.PressOnDatePickerMonthSelector
	 */
	var PressOnDatePickerMonthSelector = GenericPress.extend("{app.id}.test.tools.actions.PressOnDatePickerMonthSelector", {
		...
		executeOn : function (oControl) {
			this.genericExecuteOn(oControl, "button.sapUiCalHeadBFirst");
		}
	});
	return PressOnDatePickerMonthSelector;
