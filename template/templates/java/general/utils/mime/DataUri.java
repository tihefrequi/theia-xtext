...
public class DataUri {
    ...
    public static DataUri parse(String uri, Charset charset) {
        ...
        final byte[] finalData = "base64".equalsIgnoreCase(contentEncoding) ? Base64.decodeBase64(data)
            : data.getBytes(charset);

        DataUri dataURIObject = new DataUri(
            finalMimeType, finalCharset, finalFilename, finalContentDisposition, finalData);
    ...
    public static final DataUri ONETRANSPARANETPIXEL = parse(
        "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=",
        StandardCharsets.UTF_8);// parse("...", StandardCharsets.UTF_8);
